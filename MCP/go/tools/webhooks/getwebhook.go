...
func GetwebhookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetWebhookResult
...
func CreateGetwebhookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_webhooks_webhookId",
		mcp.WithDescription(" Returns the webhook information that corresponds to a specified webhook ID. "),
