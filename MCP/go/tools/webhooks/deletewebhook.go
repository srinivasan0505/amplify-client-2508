...
func DeletewebhookHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteWebhookResult
...
func CreateDeletewebhookTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_webhooks_webhookId",
		mcp.WithDescription(" Deletes a webhook. "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletewebhookHandler(cfg),
	}
}
