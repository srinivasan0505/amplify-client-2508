...
func DeleteappHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteAppResult
...
func CreateDeleteappTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apps_appId",
		mcp.WithDescription(" Deletes an existing Amplify app specified by an app ID. "),
