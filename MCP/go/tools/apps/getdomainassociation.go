...
func GetdomainassociationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetDomainAssociationResult
...
func CreateGetdomainassociationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apps_appId_domains_domainName",
		mcp.WithDescription(" Returns the domain information for an Amplify app. "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetdomainassociationHandler(cfg),
	}
}
