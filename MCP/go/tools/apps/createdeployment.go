...
func CreatedeploymentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateDeploymentrequest
		...
		url := fmt.Sprintf("%s/apps/%s/branches/%s/deployments", cfg.BaseURL, appId, branchName)
		...
		var result models.CreateDeploymentResult
...
func CreateCreatedeploymentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apps_appId_branches_branchName_deployments",
		mcp.WithDescription(" Creates a deployment for a manually deployed Amplify app. Manually deployed apps are not connected to a repository. "),
