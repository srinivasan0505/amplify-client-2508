...
func DeletejobHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteJobResult
...
func CreateDeletejobTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apps_appId_branches_branchName_jobs_jobId",
		mcp.WithDescription(" Deletes a job for a branch of an Amplify app. "),
