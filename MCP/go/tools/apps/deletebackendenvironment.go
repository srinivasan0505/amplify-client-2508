...
func DeletebackendenvironmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apps/%s/backendenvironments/%s", cfg.BaseURL, appId, environmentName)
		...
		var result models.DeleteBackendEnvironmentResult
...
func CreateDeletebackendenvironmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apps_appId_backendenvironments_environmentName",
		mcp.WithDescription(" Deletes a backend environment for an Amplify app. "),
		...
		mcp.WithString("appId", mcp.Required(), mcp.Description(" The unique ID of an Amplify app. ")),
		mcp.WithString("environmentName", mcp.Required(), mcp.Description(" The name of a backend environment of an Amplify app. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DeletebackendenvironmentHandler(cfg),
	}
}
