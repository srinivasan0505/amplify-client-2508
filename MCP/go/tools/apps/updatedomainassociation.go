...
func UpdatedomainassociationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateDomainAssociationrequest
		...
		var result models.UpdateDomainAssociationResult
...
func CreateUpdatedomainassociationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apps_appId_domains_domainName",
		mcp.WithDescription(" Creates a new domain association for an Amplify app."),
		...
		mcp.WithArray("subDomainSettings", mcp.Description("Input parameter:  Describes the settings for the subdomain. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdatedomainassociationHandler(cfg),
	}
}
