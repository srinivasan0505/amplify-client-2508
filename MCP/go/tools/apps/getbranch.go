...
func GetbranchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetBranchResult
...
func CreateGetbranchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apps_appId_branches_branchName",
		mcp.WithDescription(" Returns a branch for an Amplify app. "),
