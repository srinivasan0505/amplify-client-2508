...
func GetappHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetAppResult
...
func CreateGetappTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apps_appId",
		mcp.WithDescription(" Returns an existing Amplify app by appID. "),
