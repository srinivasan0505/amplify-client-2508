...
func DeletebranchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DeleteBranchResult
...
func CreateDeletebranchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_apps_appId_branches_branchName",
		mcp.WithDescription(" Deletes a branch for an Amplify app. "),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletebranchHandler(cfg),
	}
}
