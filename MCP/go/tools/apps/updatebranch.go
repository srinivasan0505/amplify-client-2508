...
func UpdatebranchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateBranchrequest
		...
		url := fmt.Sprintf("%s/apps/%s/branches/%s", cfg.BaseURL, appId, branchName)
		...
		var result models.UpdateBranchResult
...
func CreateUpdatebranchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_apps_appId_branches_branchName",
		mcp.WithDescription(" Updates a branch for an Amplify app. "),
		...
		mcp.WithString("branchName", mcp.Required(), mcp.Description(" The name for the branch. ")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatebranchHandler(cfg),
	}
}
