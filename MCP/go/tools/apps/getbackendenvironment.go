...
func GetbackendenvironmentHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GetBackendEnvironmentResult
...
func CreateGetbackendenvironmentTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_apps_appId_backendenvironments_environmentName",
		mcp.WithDescription(" Returns a backend environment for an Amplify app. "),
		...
		mcp.WithString("environmentName", mcp.Required(), mcp.Description(" The name for the backend environment. ")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    GetbackendenvironmentHandler(cfg),
	}
}
