...
func CreateListtagsforresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_tags_resourceArn",
		mcp.WithDescription(" Returns a list of tags for a specified Amazon Resource Name (ARN). "),
		...
		mcp.WithString("resourceArn", mcp.Required(), mcp.Description(" The Amazon Resource Name (ARN) to use to list tags. ")),
	)
