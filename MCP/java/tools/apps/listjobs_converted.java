/**
 * MCP Server function for Lists the jobs for a branch of an Amplify app.
 */
...
class Get_Apps_App_Id_Branches_Branch_Name_JobsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Apps_App_Id_Branches_Branch_Name_JobsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("maxResults")) {
            queryParams.add("maxResults=" + args.get("maxResults"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_apps_app_id_branches_branch_name_jobs" + queryString;
    ...
    public static MCPServer.Tool createGet_Apps_App_Id_Branches_Branch_Name_JobsTool(MCPServer.APIConfig config) {
        ...
        branchNameProperty.put("description", "The name for a branch.");
        ...
        nextTokenProperty.put("description", "A pagination token. Set to null to start listing steps from the start. If a non-null pagination token is returned in a result, pass its value in here to list more steps.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_apps_app_id_branches_branch_name_jobs",
            "Lists the jobs for a branch of an Amplify app.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Apps_App_Id_Branches_Branch_Name_JobsHandler(config));
    }
