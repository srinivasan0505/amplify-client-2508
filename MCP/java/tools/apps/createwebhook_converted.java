/**
 * MCP Server function for Creates a new webhook on an Amplify app.
 */
...
class Post_Apps_App_Id_WebhooksMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Apps_App_Id_WebhooksHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("branchName")) {
            queryParams.add("branchName=" + args.get("branchName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_apps_app_id_webhooks" + queryString;
    ...
    public static MCPServer.Tool createPost_Apps_App_Id_WebhooksTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_apps_app_id_webhooks",
            "Creates a new webhook on an Amplify app.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Apps_App_Id_WebhooksHandler(config));
    }
