/**
 * MCP Server function for Creates a new Amplify app.
 */
...
class Post_AppsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_AppsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("customRules")) {
            queryParams.add("customRules=" + args.get("customRules"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_apps" + queryString;
    ...
    public static MCPServer.Tool createPost_AppsTool(MCPServer.APIConfig config) {
        ...
        repositoryProperty.put("description", "Input parameter: The repository for an Amplify app.");
        ...
        basicAuthCredentialsProperty.put("description", "Input parameter: The credentials for basic authorization for an Amplify app. You must base64-encode the authorization credentials and provide them in the format <code>user:password</code>.");
        ...
        enableBasicAuthProperty.put("description", "Input parameter: Enables basic authorization for an Amplify app. This will apply to all branches that are part of this app.");
        ...
        enableBranchAutoBuildProperty.put("description", "Input parameter: Enables the auto building of branches for an Amplify app.");
        ...
        tagsProperty.put("description", "Input parameter: The tag for an Amplify app.");
        ...
        environmentVariablesProperty.put("description", "Input parameter: The environment variables map for an Amplify app.");
        ...
        autoBranchCreationPatternsProperty.put("description", "Input parameter: The automated branch creation glob patterns for an Amplify app.");
        ...
        customRulesProperty.put("description", "Input parameter: The custom rewrite and redirect rules for an Amplify app.");
        ...
        return new MCPServer.Tool(definition, getPost_AppsHandler(config));
    }
