...
public class CreateBranchResultBranch {
  ...
  public CreateBranchResultBranch() {
  }

  public CreateBranchResultBranch branchArn(@javax.annotation.Nonnull String branchArn) {
  ...
  public CreateBranchResultBranch branchName(@javax.annotation.Nonnull String branchName) {
  ...
  public CreateBranchResultBranch description(@javax.annotation.Nonnull String description) {
  ...
  public CreateBranchResultBranch tags(@javax.annotation.Nullable Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateBranchResultBranch stage(@javax.annotation.Nonnull Stage stage) {
    this.stage = stage;
    return this;
  }
  ...
  public CreateBranchResultBranch displayName(@javax.annotation.Nonnull String displayName) {
  ...
  public CreateBranchResultBranch enableNotification(@javax.annotation.Nonnull Boolean enableNotification) {
  ...
  public CreateBranchResultBranch createTime(@javax.annotation.Nonnull OffsetDateTime createTime) {
  ...
  public CreateBranchResultBranch updateTime(@javax.annotation.Nonnull OffsetDateTime updateTime) {
  ...
  public CreateBranchResultBranch environmentVariables(@javax.annotation.Nonnull Map environmentVariables) {
  ...
  public CreateBranchResultBranch enableAutoBuild(@javax.annotation.Nonnull Boolean enableAutoBuild) {
  ...
  public CreateBranchResultBranch customDomains(@javax.annotation.Nonnull List customDomains) {
  ...
  public CreateBranchResultBranch framework(@javax.annotation.Nonnull String framework) {
  ...
  public CreateBranchResultBranch activeJobId(@javax.annotation.Nonnull String activeJobId) {
  ...
  public CreateBranchResultBranch totalNumberOfJobs(@javax.annotation.Nonnull String totalNumberOfJobs) {
  ...
  public CreateBranchResultBranch enableBasicAuth(@javax.annotation.Nonnull Boolean enableBasicAuth) {
  ...
  public CreateBranchResultBranch enablePerformanceMode(@javax.annotation.Nullable Boolean enablePerformanceMode) {
  ...
  public CreateBranchResultBranch thumbnailUrl(@javax.annotation.Nullable String thumbnailUrl) {
  ...
  public CreateBranchResultBranch basicAuthCredentials(@javax.annotation.Nullable String basicAuthCredentials) {
  ...
  public CreateBranchResultBranch buildSpec(@javax.annotation.Nullable String buildSpec) {
  ...
  public CreateBranchResultBranch ttl(@javax.annotation.Nonnull String ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  public CreateBranchResultBranch associatedResources(@javax.annotation.Nullable List associatedResources) {
  ...
  public CreateBranchResultBranch enablePullRequestPreview(@javax.annotation.Nonnull Boolean enablePullRequestPreview) {
  ...
  public CreateBranchResultBranch pullRequestEnvironmentName(@javax.annotation.Nullable String pullRequestEnvironmentName) {
  ...
  public CreateBranchResultBranch destinationBranch(@javax.annotation.Nullable String destinationBranch) {
  ...
  public CreateBranchResultBranch sourceBranch(@javax.annotation.Nullable String sourceBranch) {
  ...
  public CreateBranchResultBranch backendEnvironmentArn(@javax.annotation.Nullable String backendEnvironmentArn) {
  ...
  public boolean equals(Object o) {
    ...
    CreateBranchResultBranch createBranchResultBranch = (CreateBranchResultBranch) o;
    return Objects.equals(this.branchArn, createBranchResultBranch.branchArn) &&
        Objects.equals(this.branchName, createBranchResultBranch.branchName) &&
        Objects.equals(this.description, createBranchResultBranch.description) &&
        Objects.equals(this.tags, createBranchResultBranch.tags) &&
        Objects.equals(this.stage, createBranchResultBranch.stage) &&
        Objects.equals(this.displayName, createBranchResultBranch.displayName) &&
        Objects.equals(this.enableNotification, createBranchResultBranch.enableNotification) &&
        Objects.equals(this.createTime, createBranchResultBranch.createTime) &&
        Objects.equals(this.updateTime, createBranchResultBranch.updateTime) &&
        Objects.equals(this.environmentVariables, createBranchResultBranch.environmentVariables) &&
        Objects.equals(this.enableAutoBuild, createBranchResultBranch.enableAutoBuild) &&
        Objects.equals(this.customDomains, createBranchResultBranch.customDomains) &&
        Objects.equals(this.framework, createBranchResultBranch.framework) &&
        Objects.equals(this.activeJobId, createBranchResultBranch.activeJobId) &&
        Objects.equals(this.totalNumberOfJobs, createBranchResultBranch.totalNumberOfJobs) &&
        Objects.equals(this.enableBasicAuth, createBranchResultBranch.enableBasicAuth) &&
        Objects.equals(this.enablePerformanceMode, createBranchResultBranch.enablePerformanceMode) &&
        Objects.equals(this.thumbnailUrl, createBranchResultBranch.thumbnailUrl) &&
        Objects.equals(this.basicAuthCredentials, createBranchResultBranch.basicAuthCredentials) &&
        Objects.equals(this.buildSpec, createBranchResultBranch.buildSpec) &&
        Objects.equals(this.ttl, createBranchResultBranch.ttl) &&
        Objects.equals(this.associatedResources, createBranchResultBranch.associatedResources) &&
        Objects.equals(this.enablePullRequestPreview, createBranchResultBranch.enablePullRequestPreview) &&
        Objects.equals(this.pullRequestEnvironmentName, createBranchResultBranch.pullRequestEnvironmentName) &&
        Objects.equals(this.destinationBranch, createBranchResultBranch.destinationBranch) &&
        Objects.equals(this.sourceBranch, createBranchResultBranch.sourceBranch) &&
        Objects.equals(this.backendEnvironmentArn, createBranchResultBranch.backendEnvironmentArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateBranchResultBranch {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateBranchResultBranch
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateBranchResultBranch.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateBranchResultBranch is not found in the empty JSON string", CreateBranchResultBranch.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateBranchResultBranch.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateBranchResultBranch` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateBranchResultBranch.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateBranchResultBranch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateBranchResultBranch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateBranchResultBranch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateBranchResultBranch.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateBranchResultBranch>() {
           @Override
           public void write(JsonWriter out, CreateBranchResultBranch value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateBranchResultBranch read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateBranchResultBranch given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateBranchResultBranch
   * @throws IOException if the JSON string is invalid with respect to CreateBranchResultBranch
   */
  public static CreateBranchResultBranch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateBranchResultBranch.class);
  }

  /**
   * Convert an instance of CreateBranchResultBranch to an JSON string
   *
   * @return JSON string
   */
