...
public class AutoBranchCreationConfig {
  ...
  public AutoBranchCreationConfig stage(@javax.annotation.Nullable Stage stage) {
    this.stage = stage;
    return this;
  }
  ...
  public AutoBranchCreationConfig framework(@javax.annotation.Nullable String framework) {
  ...
  public AutoBranchCreationConfig enableAutoBuild(@javax.annotation.Nullable Boolean enableAutoBuild) {
  ...
  public AutoBranchCreationConfig environmentVariables(@javax.annotation.Nullable Map environmentVariables) {
  ...
  public AutoBranchCreationConfig basicAuthCredentials(@javax.annotation.Nullable String basicAuthCredentials) {
  ...
  public AutoBranchCreationConfig enableBasicAuth(@javax.annotation.Nullable Boolean enableBasicAuth) {
  ...
  public AutoBranchCreationConfig enablePerformanceMode(@javax.annotation.Nullable Boolean enablePerformanceMode) {
  ...
  public AutoBranchCreationConfig buildSpec(@javax.annotation.Nullable String buildSpec) {
  ...
  public AutoBranchCreationConfig enablePullRequestPreview(@javax.annotation.Nullable Boolean enablePullRequestPreview) {
  ...
  public AutoBranchCreationConfig pullRequestEnvironmentName(@javax.annotation.Nullable String pullRequestEnvironmentName) {
  ...
  public boolean equals(Object o) {
    ...
    AutoBranchCreationConfig autoBranchCreationConfig = (AutoBranchCreationConfig) o;
    return Objects.equals(this.stage, autoBranchCreationConfig.stage) &&
        Objects.equals(this.framework, autoBranchCreationConfig.framework) &&
        Objects.equals(this.enableAutoBuild, autoBranchCreationConfig.enableAutoBuild) &&
        Objects.equals(this.environmentVariables, autoBranchCreationConfig.environmentVariables) &&
        Objects.equals(this.basicAuthCredentials, autoBranchCreationConfig.basicAuthCredentials) &&
        Objects.equals(this.enableBasicAuth, autoBranchCreationConfig.enableBasicAuth) &&
        Objects.equals(this.enablePerformanceMode, autoBranchCreationConfig.enablePerformanceMode) &&
        Objects.equals(this.buildSpec, autoBranchCreationConfig.buildSpec) &&
        Objects.equals(this.enablePullRequestPreview, autoBranchCreationConfig.enablePullRequestPreview) &&
        Objects.equals(this.pullRequestEnvironmentName, autoBranchCreationConfig.pullRequestEnvironmentName);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoBranchCreationConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoBranchCreationConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoBranchCreationConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoBranchCreationConfig is not found in the empty JSON string", AutoBranchCreationConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoBranchCreationConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoBranchCreationConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoBranchCreationConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoBranchCreationConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoBranchCreationConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoBranchCreationConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoBranchCreationConfig>() {
           @Override
           public void write(JsonWriter out, AutoBranchCreationConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoBranchCreationConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoBranchCreationConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoBranchCreationConfig
   * @throws IOException if the JSON string is invalid with respect to AutoBranchCreationConfig
   */
  public static AutoBranchCreationConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoBranchCreationConfig.class);
  }

  /**
   * Convert an instance of AutoBranchCreationConfig to an JSON string
   *
   * @return JSON string
   */
