...
public class DomainAssociation {
  ...
  public DomainAssociation domainAssociationArn(@javax.annotation.Nonnull String domainAssociationArn) {
  ...
  public DomainAssociation domainName(@javax.annotation.Nonnull String domainName) {
  ...
  public DomainAssociation enableAutoSubDomain(@javax.annotation.Nonnull Boolean enableAutoSubDomain) {
  ...
  public DomainAssociation autoSubDomainCreationPatterns(@javax.annotation.Nullable List autoSubDomainCreationPatterns) {
  ...
  public DomainAssociation autoSubDomainIAMRole(@javax.annotation.Nullable String autoSubDomainIAMRole) {
  ...
  public DomainAssociation domainStatus(@javax.annotation.Nonnull DomainStatus domainStatus) {
  ...
  public DomainAssociation statusReason(@javax.annotation.Nonnull String statusReason) {
  ...
  public DomainAssociation certificateVerificationDNSRecord(@javax.annotation.Nullable String certificateVerificationDNSRecord) {
  ...
  public DomainAssociation subDomains(@javax.annotation.Nonnull List subDomains) {
  ...
  public boolean equals(Object o) {
    ...
    DomainAssociation domainAssociation = (DomainAssociation) o;
    return Objects.equals(this.domainAssociationArn, domainAssociation.domainAssociationArn) &&
        Objects.equals(this.domainName, domainAssociation.domainName) &&
        Objects.equals(this.enableAutoSubDomain, domainAssociation.enableAutoSubDomain) &&
        Objects.equals(this.autoSubDomainCreationPatterns, domainAssociation.autoSubDomainCreationPatterns) &&
        Objects.equals(this.autoSubDomainIAMRole, domainAssociation.autoSubDomainIAMRole) &&
        Objects.equals(this.domainStatus, domainAssociation.domainStatus) &&
        Objects.equals(this.statusReason, domainAssociation.statusReason) &&
        Objects.equals(this.certificateVerificationDNSRecord, domainAssociation.certificateVerificationDNSRecord) &&
        Objects.equals(this.subDomains, domainAssociation.subDomains);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainAssociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainAssociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainAssociation is not found in the empty JSON string", DomainAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainAssociation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainAssociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainAssociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainAssociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainAssociation.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainAssociation>() {
           @Override
           public void write(JsonWriter out, DomainAssociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainAssociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainAssociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainAssociation
   * @throws IOException if the JSON string is invalid with respect to DomainAssociation
   */
  public static DomainAssociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainAssociation.class);
  }

  /**
   * Convert an instance of DomainAssociation to an JSON string
   *
   * @return JSON string
   */
