...
public class CreateDomainAssociationResultDomainAssociation {
  ...
  public CreateDomainAssociationResultDomainAssociation() {
  }

  public CreateDomainAssociationResultDomainAssociation domainAssociationArn(@javax.annotation.Nonnull String domainAssociationArn) {
  ...
  public CreateDomainAssociationResultDomainAssociation domainName(@javax.annotation.Nonnull String domainName) {
  ...
  public CreateDomainAssociationResultDomainAssociation enableAutoSubDomain(@javax.annotation.Nonnull Boolean enableAutoSubDomain) {
  ...
  public CreateDomainAssociationResultDomainAssociation autoSubDomainCreationPatterns(@javax.annotation.Nullable List autoSubDomainCreationPatterns) {
  ...
  public CreateDomainAssociationResultDomainAssociation autoSubDomainIAMRole(@javax.annotation.Nullable String autoSubDomainIAMRole) {
  ...
  public CreateDomainAssociationResultDomainAssociation domainStatus(@javax.annotation.Nonnull DomainStatus domainStatus) {
  ...
  public CreateDomainAssociationResultDomainAssociation statusReason(@javax.annotation.Nonnull String statusReason) {
  ...
  public CreateDomainAssociationResultDomainAssociation certificateVerificationDNSRecord(@javax.annotation.Nullable String certificateVerificationDNSRecord) {
  ...
  public CreateDomainAssociationResultDomainAssociation subDomains(@javax.annotation.Nonnull List subDomains) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDomainAssociationResultDomainAssociation createDomainAssociationResultDomainAssociation = (CreateDomainAssociationResultDomainAssociation) o;
    return Objects.equals(this.domainAssociationArn, createDomainAssociationResultDomainAssociation.domainAssociationArn) &&
        Objects.equals(this.domainName, createDomainAssociationResultDomainAssociation.domainName) &&
        Objects.equals(this.enableAutoSubDomain, createDomainAssociationResultDomainAssociation.enableAutoSubDomain) &&
        Objects.equals(this.autoSubDomainCreationPatterns, createDomainAssociationResultDomainAssociation.autoSubDomainCreationPatterns) &&
        Objects.equals(this.autoSubDomainIAMRole, createDomainAssociationResultDomainAssociation.autoSubDomainIAMRole) &&
        Objects.equals(this.domainStatus, createDomainAssociationResultDomainAssociation.domainStatus) &&
        Objects.equals(this.statusReason, createDomainAssociationResultDomainAssociation.statusReason) &&
        Objects.equals(this.certificateVerificationDNSRecord, createDomainAssociationResultDomainAssociation.certificateVerificationDNSRecord) &&
        Objects.equals(this.subDomains, createDomainAssociationResultDomainAssociation.subDomains);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDomainAssociationResultDomainAssociation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDomainAssociationResultDomainAssociation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDomainAssociationResultDomainAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDomainAssociationResultDomainAssociation is not found in the empty JSON string", CreateDomainAssociationResultDomainAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDomainAssociationResultDomainAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDomainAssociationResultDomainAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDomainAssociationResultDomainAssociation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDomainAssociationResultDomainAssociation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDomainAssociationResultDomainAssociation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDomainAssociationResultDomainAssociation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDomainAssociationResultDomainAssociation.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDomainAssociationResultDomainAssociation>() {
           @Override
           public void write(JsonWriter out, CreateDomainAssociationResultDomainAssociation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDomainAssociationResultDomainAssociation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDomainAssociationResultDomainAssociation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDomainAssociationResultDomainAssociation
   * @throws IOException if the JSON string is invalid with respect to CreateDomainAssociationResultDomainAssociation
   */
  public static CreateDomainAssociationResultDomainAssociation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDomainAssociationResultDomainAssociation.class);
  }

  /**
   * Convert an instance of CreateDomainAssociationResultDomainAssociation to an JSON string
   *
   * @return JSON string
   */
