 ...
 * Gets or Sets Stage
 */
@JsonAdapter(Stage.Adapter.class)
public enum Stage {
  ...
  public static class Adapter extends TypeAdapter<Stage> {
    @Override
    public void write(final JsonWriter jsonWriter, final Stage enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Stage read(final JsonReader jsonReader) throws IOException {
