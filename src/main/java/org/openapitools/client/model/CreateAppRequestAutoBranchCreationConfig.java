...
public class CreateAppRequestAutoBranchCreationConfig {
  ...
  public CreateAppRequestAutoBranchCreationConfig() {
  }

  public CreateAppRequestAutoBranchCreationConfig stage(@javax.annotation.Nullable Stage stage) {
    this.stage = stage;
    return this;
  }
  ...
  public CreateAppRequestAutoBranchCreationConfig framework(@javax.annotation.Nullable String framework) {
  ...
  public CreateAppRequestAutoBranchCreationConfig enableAutoBuild(@javax.annotation.Nullable Boolean enableAutoBuild) {
  ...
  public CreateAppRequestAutoBranchCreationConfig environmentVariables(@javax.annotation.Nullable Map environmentVariables) {
  ...
  public CreateAppRequestAutoBranchCreationConfig basicAuthCredentials(@javax.annotation.Nullable String basicAuthCredentials) {
  ...
  public CreateAppRequestAutoBranchCreationConfig enableBasicAuth(@javax.annotation.Nullable Boolean enableBasicAuth) {
  ...
  public CreateAppRequestAutoBranchCreationConfig enablePerformanceMode(@javax.annotation.Nullable Boolean enablePerformanceMode) {
  ...
  public CreateAppRequestAutoBranchCreationConfig buildSpec(@javax.annotation.Nullable String buildSpec) {
  ...
  public CreateAppRequestAutoBranchCreationConfig enablePullRequestPreview(@javax.annotation.Nullable Boolean enablePullRequestPreview) {
  ...
  public CreateAppRequestAutoBranchCreationConfig pullRequestEnvironmentName(@javax.annotation.Nullable String pullRequestEnvironmentName) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAppRequestAutoBranchCreationConfig createAppRequestAutoBranchCreationConfig = (CreateAppRequestAutoBranchCreationConfig) o;
    return Objects.equals(this.stage, createAppRequestAutoBranchCreationConfig.stage) &&
        Objects.equals(this.framework, createAppRequestAutoBranchCreationConfig.framework) &&
        Objects.equals(this.enableAutoBuild, createAppRequestAutoBranchCreationConfig.enableAutoBuild) &&
        Objects.equals(this.environmentVariables, createAppRequestAutoBranchCreationConfig.environmentVariables) &&
        Objects.equals(this.basicAuthCredentials, createAppRequestAutoBranchCreationConfig.basicAuthCredentials) &&
        Objects.equals(this.enableBasicAuth, createAppRequestAutoBranchCreationConfig.enableBasicAuth) &&
        Objects.equals(this.enablePerformanceMode, createAppRequestAutoBranchCreationConfig.enablePerformanceMode) &&
        Objects.equals(this.buildSpec, createAppRequestAutoBranchCreationConfig.buildSpec) &&
        Objects.equals(this.enablePullRequestPreview, createAppRequestAutoBranchCreationConfig.enablePullRequestPreview) &&
        Objects.equals(this.pullRequestEnvironmentName, createAppRequestAutoBranchCreationConfig.pullRequestEnvironmentName);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAppRequestAutoBranchCreationConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAppRequestAutoBranchCreationConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAppRequestAutoBranchCreationConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAppRequestAutoBranchCreationConfig is not found in the empty JSON string", CreateAppRequestAutoBranchCreationConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAppRequestAutoBranchCreationConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateAppRequestAutoBranchCreationConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAppRequestAutoBranchCreationConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAppRequestAutoBranchCreationConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAppRequestAutoBranchCreationConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAppRequestAutoBranchCreationConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAppRequestAutoBranchCreationConfig>() {
           @Override
           public void write(JsonWriter out, CreateAppRequestAutoBranchCreationConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAppRequestAutoBranchCreationConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAppRequestAutoBranchCreationConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAppRequestAutoBranchCreationConfig
   * @throws IOException if the JSON string is invalid with respect to CreateAppRequestAutoBranchCreationConfig
   */
  public static CreateAppRequestAutoBranchCreationConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAppRequestAutoBranchCreationConfig.class);
  }

  /**
   * Convert an instance of CreateAppRequestAutoBranchCreationConfig to an JSON string
   *
   * @return JSON string
   */
