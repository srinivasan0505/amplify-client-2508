...
public class CreateDeploymentRequest {
  public static final String SERIALIZED_NAME_FILE_MAP = "fileMap";
  @SerializedName(SERIALIZED_NAME_FILE_MAP)
  ...
  public CreateDeploymentRequest fileMap(@javax.annotation.Nullable Map<String, String> fileMap) {
    this.fileMap = fileMap;
    return this;
  }

  public CreateDeploymentRequest putFileMapItem(String key, String fileMapItem) {
    if (this.fileMap == null) {
      this.fileMap = new HashMap<>();
    }
    this.fileMap.put(key, fileMapItem);
    return this;
  }
  ...
  public void setFileMap(@javax.annotation.Nullable Map<String, String> fileMap) {
    this.fileMap = fileMap;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fileMap, createDeploymentRequest.fileMap);
  }
  ...
  public String toString() {
    ...
    sb.append("    fileMap: ").append(toIndentedString(fileMap)).append("\n");
    sb.append("}");
    return sb.toString();
  }
